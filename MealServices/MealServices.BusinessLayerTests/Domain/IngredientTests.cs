...
namespace MealServices.BusinessLayer.DomainTests
{
    ...
    public class IngredientTests
    {
        ...
        private readonly Meal Club = new Meal(new StringTranslated("Club", "Club", "Club"), new Supplier { Id = 33, Name = "Supplier1" });
        private readonly Meal BrieNoix = new Meal(new StringTranslated("Brie", "Brie", "Brie"), new Supplier { Id = 33, Name = "Supplier1" });
        private readonly Meal PestoVerde = new Meal(new StringTranslated("Pesto", "Pesto", "Pesto"), new Supplier { Id = 33, Name = "Supplier1" });
