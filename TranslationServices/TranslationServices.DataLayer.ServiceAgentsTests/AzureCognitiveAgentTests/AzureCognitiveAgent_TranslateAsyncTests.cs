...
namespace TranslationServices.DataLayer.ServiceAgentsTests
{
    public class AzureCognitiveAgent_TranslateAsyncTests
    {
        ...
        public async Task  TranslateAsync_ShouldTranslate_WhenValidSentenceIsProvided(Language FromLangue, string StringToTranslate, Language ToLangue, string StringTranlated)
        {
            //ARRANGE
            ...
            var AzCognitiveTranslatedSentence = await TranslatorToTest.TranslateAsync(args);
        ...
        [Fact]
        public void TranslateAsync_ThrowsArgumentNullException_WhenStringToTranslateIsNull()
        {
            //ARRANGE
            var mockILogger = TestHelper.MockILogger();
            ...
            //ACT & ASSERT
            Assert.ThrowsAsync<IsNullOrWhiteSpaceException>(async () => await TranslatorToTest.TranslateAsync(args));
            mockILogger.Verify(x => x.Error(It.IsAny<string>()), Times.Once);
        }

        [Fact]
        public void TranslateAsync_ThrowsArgumentNullException_WhenStringToTranslateIsEmpty()
        {
            //ARRANGE
            var mockILogger = TestHelper.MockILogger();
        ...
        [Fact]
        public void TranslateAsync_ThrowsArgumentNullException_WhenStringToTranslateIsWhiteSpace()
        {
            //ARRANGE
            var mockILogger = TestHelper.MockILogger();
        ...
        [Fact]
        public void TranslateAsync_ThrowsArgumentException_WhenFromLangueEqualsToLangue()
        {
            //ARRANGE
            var mockILogger = TestHelper.MockILogger();
            ...
            //ACT & ASSERT
            Assert.ThrowsAsync<ArgumentException>(async () => await TranslatorToTest.TranslateAsync(args));
            mockILogger.Verify(x => x.Error(It.IsAny<string>()), Times.Once);
        }

        [Fact]
        public void TranslateAsync_ThrowsArgumentOutOfRange_WhenFromLangueIsNotDefinedInEnum()
        {
            //ARRANGE
            var mockILogger = TestHelper.MockILogger();
            ...
            //ACT & ASSERT
            Assert.ThrowsAsync<ArgumentOutOfRangeException>(async () => await TranslatorToTest.TranslateAsync(args));
            mockILogger.Verify(x => x.Error(It.IsAny<string>()), Times.Once);
        }

        [Fact]
        public void TranslateAsync_ThrowsArgumentOutOfRange_WhenToLangueIsNotDefinedInEnum()
        {
            //ARRANGE
            var mockILogger = TestHelper.MockILogger();
